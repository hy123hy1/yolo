...
def detect_intrusion2(frame, camera_id, rtsp_url, config,
...
if __name__ == "__main__":
    ...
    cams = [('101', 'rtsp://admin:sxhbjq123@192.168.1.2:554/Streaming/Channels/101', '192.168.1.1')]
